...
- 📚 Currently contributing as a [**Blog Editor** for **Cambridge University Press**](https://dataforpolicy.org/team_member/muhammad-faizan-haider/), sharpening my communication and content curation skills.
- 🔧 An **Associate Member** of the [**Institution of Engineering and Technology (IET) London**](https://www.theiet.org/membership), actively engaged with professional and technological communities.
